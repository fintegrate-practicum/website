...
//     setLoading(true);
//     try {
//       const res = await getAllItems<IComponent[]>('inventory/component/businessId/here will be the business id');
      ...
      <Grid container spacing={2}>
        ...
        {customFields.map((customField, index) => (
          <Grid item xs={12} key={index} container spacing={2}>
            ...
            <Grid item xs={4}>
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  onChange={(e) =>
                    handleCustomFieldChange(index, 'fieldType', e.target.value)
                  }
            ...
            {/* Render the preview based on the selected field type */}
            <Grid item xs={12}>
              <Box>
                    ...
                    children:
                      customField.fieldType === ComponentType.Select
                        ...
                        : customField.fieldType === ComponentType.ButtonGroup
                          ...
                          : customField.fieldType === ComponentType.Button ||
                              customField.fieldType === ComponentType.Input
