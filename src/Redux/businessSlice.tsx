...
export const checkEmailVerificationCode = createAsyncThunk(
	'',
	async (payload: { email: string | undefined; code: string }) => {
		try {
			const response = await infraInstance.get(`/verification/validate`, {
